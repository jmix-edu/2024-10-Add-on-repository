...
@PropertySource(name = "com.company.viewaudit", value = "classpath:/com/company/viewaudit/module.properties")
public class VaConfiguration {

    @Bean("va_VaViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.company.viewaudit"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.company.viewaudit"));
        return actions;
    }
}
